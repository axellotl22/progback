...
from app.routers import clustering_router, basic_kmeans_router
...
app.include_router(clustering_router.router, prefix="/clustering", tags=["K-Means"])
app.include_router(basic_kmeans_router.router, prefix="/basic", tags=["K-Means"])
# Authentication
